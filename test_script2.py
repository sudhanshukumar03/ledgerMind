...
EXCEPTION_UUID = "570895c3-217e-4941-9c24-7efb7cb3d1fa"
...
def main():
    ...
    action_res = req(f"{BASE_URL}/actions", method="POST", token=token, data={"exception_id": EXCEPTION_UUID, "action_type": "MARK_REVIEWED", "parameters": {"reason": "Test"}})
